...
// CHANGED 4 COLORS RELATED TO LIKES ICON
...
- (void)createView {    
    ...
    [self.photographer fetchIfNeededInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        ...
        //COLOR!
        [userButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        [userButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateHighlighted];
        ...
        //CHANGE COLOR
        [timeLabel setTextColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f]];
    ...
    //CHANGE COLOR
    [likeButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
