...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"d8ENVRxovxYPBEiGKIYOAngqNrGqqLErjVaGJaax" clientKey:@"JJfwzL5lG6e39QZYF3HuJ5kyrxBNSy1Bs3DEBC2R"];
    ...
    self.window.backgroundColor = [UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
...
- (void)presentTabBarController {    
    ...
    //CHAGNED COLOR
    [homeTabBarItem setTitleTextAttributes: @{ NSForegroundColorAttributeName: [UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f], NSFontAttributeName: [UIFont boldSystemFontOfSize:13] } forState:UIControlStateNormal];
...
//COLOR
  ...
  // 3 COLOR CHANGES
    ...
    [[UIButton appearanceWhenContainedIn:[UINavigationBar class], nil]
     //change color
     setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f]
     forState:UIControlStateNormal];
    
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{
                                NSForegroundColorAttributeName:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f]
                                }
                                forState:UIControlStateNormal];
