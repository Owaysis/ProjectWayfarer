...
//
//  CHANGED 3 THINGS + CELL TITLE COLORS
...
- (id)initWithFrame:(CGRect)frame buttons:(PAPPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        ...
        if (self.buttons & PAPPhotoHeaderButtonsComment) {
            ...
            //CHANGE COLOR
            [self.commentButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        if (self.buttons & PAPPhotoHeaderButtonsLike) {
            ...
            //CHANGE COLOR
            [self.likeButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        if (self.buttons & PAPPhotoHeaderButtonsUser) {
            ...
            //CHANGE COLOR
            [self.userButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        [self.timestampLabel setTextColor:[UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f]];
